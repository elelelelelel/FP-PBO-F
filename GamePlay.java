...
public class GamePlay extends JPanel implements KeyListener, ActionListener {
	...
	public void paint(Graphics g) {
		...
		g.drawString("Scores: " + score, 720, 30);
		
		//draw length snake
		g.setColor(Color.white);
		g.setFont(new Font("areal", Font.PLAIN, 14));
		g.drawString("Length: " + lengthofsnake, 720, 10);
		
		//draw highscore
		g.setColor (Color.white);
		g.setFont(new Font("areal", Font.PLAIN, 14));
		g.drawString("HighScore: " + highScore, 720, 50);
	...
	public void CheckScore()
	{
		...
		{
			String name = JOptionPane.showInputDialog("New High Score. What is yout name?");
